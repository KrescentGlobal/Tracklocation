...
struct GeoKey {
    ...
    static let createdFor = "createdFor"
...
class Geotification: GMSMarker, NSCoding {
    ...
    init(coordinate: CLLocationCoordinate2D, radius: CLLocationDistance, identifier: String, note: String , createdFor: String) {
    ...
    required init?(coder decoder: NSCoder) {
        ...
        createdFor = decoder.decodeObject(forKey: GeoKey.createdFor) as! String
    }
    ...
    func encode(with coder: NSCoder) {
        ...
        coder.encode(createdFor, forKey: GeoKey.createdFor)
